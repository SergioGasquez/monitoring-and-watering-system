...
public:
    ...
    QWidget *waterTab;
    QPushButton *watterButton;
    QPushButton *waterParamsFix;
    QwtTextLabel *waterTimeLabel;
    QwtTextLabel *waterParamsLabel;
    QwtSlider *waterTimeSlider;
    QwtSlider *waterTimeSlider_2;
    QwtSlider *waterTimeSlider_3;
    ...
    void setupUi(QWidget *GUIPanel)
    {
        ...
        watterButton = new QPushButton(waterTab);
        watterButton->setObjectName(QStringLiteral("watterButton"));
        watterButton->setGeometry(QRect(640, 100, 121, 51));
        watterButton->setFont(font);
        waterParamsFix = new QPushButton(waterTab);
        waterParamsFix->setObjectName(QStringLiteral("waterParamsFix"));
        waterParamsFix->setGeometry(QRect(620, 320, 171, 71));
        waterParamsFix->setFont(font);
        ...
        waterTimeSlider_2 = new QwtSlider(waterTab);
        waterTimeSlider_2->setObjectName(QStringLiteral("waterTimeSlider_2"));
        waterTimeSlider_2->setGeometry(QRect(150, 260, 71, 191));
        waterTimeSlider_2->setLowerBound(5);
        waterTimeSlider_2->setUpperBound(60);
        waterTimeSlider_2->setOrientation(Qt::Vertical);
        waterTimeSlider_3 = new QwtSlider(waterTab);
        waterTimeSlider_3->setObjectName(QStringLiteral("waterTimeSlider_3"));
        waterTimeSlider_3->setGeometry(QRect(430, 260, 71, 191));
        waterTimeSlider_3->setLowerBound(0);
        waterTimeSlider_3->setUpperBound(100);
        waterTimeSlider_3->setOrientation(Qt::Vertical);
    ...
    void retranslateUi(QWidget *GUIPanel)
    {
        ...
        watterButton->setText(QApplication::translate("GUIPanel", "Water", Q_NULLPTR));
        waterParamsFix->setText(QApplication::translate("GUIPanel", "Set water parameters", Q_NULLPTR));
